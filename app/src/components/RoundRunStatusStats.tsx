  ...
  return (
    <div className="grid shrink-0 grid-cols-3 gap-2">
      <div className="rounded-xl border border-border/80 bg-background/70 p-3 shadow-sm">
        ...
        <div className="mt-1 font-mono text-lg font-semibold tracking-tight">{totalChunks ? `${safeCompletedChunks}/${totalChunks}` : safeCompletedChunks}</div>
      </div>
      <div className="rounded-xl border border-border/80 bg-background/70 p-3 shadow-sm">
        ...
        <div className="mt-1 font-mono text-lg font-semibold tracking-tight">{remainingChunks}</div>
      </div>
      <div className="rounded-xl border border-border/80 bg-background/70 p-3 shadow-sm">
        ...
        <div className="mt-1 font-mono text-lg font-semibold tracking-tight">{concurrencyLabel}</div>
