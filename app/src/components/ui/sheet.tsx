...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-4 bg-background p-6 shadow-[0_18px_48px_hsl(var(--foreground)/0.08)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
