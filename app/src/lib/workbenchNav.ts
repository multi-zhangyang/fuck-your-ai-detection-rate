import { Activity, BarChart3, FileText, History, Home, Settings, ShieldCheck, SlidersHorizontal } from "lucide-react";

export type WorkbenchView = "home" | "quality" | "model" | "prompts" | "format" | "protection" | "history" | "diagnostics";
...
export const WORKBENCH_NAV_ITEMS = [
  ...
  { view: "format", label: "学校规范", description: "解析并确认论文排版要求", icon: SlidersHorizontal },
