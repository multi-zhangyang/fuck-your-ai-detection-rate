...
def build_commands(
    *,
    ...
    commands: list[dict[str, Any]] = [
        ...
        {"name": "frontend sidebar navigation regression", "command": ["node", "scripts/frontend_sidebar_navigation_regression.mjs"]},
        {"name": "frontend prompt-route concurrency regression", "command": ["node", "scripts/frontend_prompt_route_concurrency_regression.mjs"]},
        ...
        {"name": "frontend Diff virtualization regression", "command": ["node", "scripts/frontend_diff_virtualization_regression.mjs"]},
        ...
        {"name": "frontend history-diagnostics integrity regression", "command": ["node", "scripts/frontend_history_diagnostics_integrity_regression.mjs"]},
        ...
        {"name": "checkpoint journal regression", "command": [sys.executable, "scripts/checkpoint_journal_regression.py"]},
        ...
        {"name": "history backup compression regression", "command": [sys.executable, "scripts/history_backup_compression_regression.py"]},
        ...
        {"name": "progress transport regression", "command": [sys.executable, "scripts/progress_transport_regression.py"]},
        ...
        {"name": "dependency governance regression", "command": [sys.executable, "scripts/dependency_governance_regression.py"]},
        {"name": "private filesystem regression", "command": [sys.executable, "scripts/private_filesystem_regression.py"]},
        ...
        {"name": "upload transport security regression", "command": [sys.executable, "scripts/upload_transport_security_regression.py"]},
